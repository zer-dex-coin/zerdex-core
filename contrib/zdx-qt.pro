...
RESOURCES += src/qt/zdx.qrc src/qt/zdx_locale.qrc

TRANSLATIONS += src/qt/locale/zdx_bg.ts \
                src/qt/locale/zdx_de.ts \
                src/qt/locale/zdx_en.ts \
                src/qt/locale/zdx_es.ts \
                src/qt/locale/zdx_fi.ts \
                src/qt/locale/zdx_fr.ts \
                src/qt/locale/zdx_it.ts \
                src/qt/locale/zdx_ja.ts \
                src/qt/locale/zdx_pl.ts \
                src/qt/locale/zdx_pt.ts \
                src/qt/locale/zdx_ru.ts \
                src/qt/locale/zdx_sk.ts \
                src/qt/locale/zdx_sv.ts \
                src/qt/locale/zdx_vi.ts \
                src/qt/locale/zdx_zh_CN.ts \
                src/qt/locale/zdx_zh_TW.ts
