...
This means one can have an always-on zdxd instance running, and another local zdxd/zdx-qt instance which connects to this node and receives blocks from it.
