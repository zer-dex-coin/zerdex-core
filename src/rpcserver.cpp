...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Zdx features */
        {"zdx", "masternode", &masternode, true, true, false},
        {"zdx", "listmasternodes", &listmasternodes, true, true, false},
        {"zdx", "getmasternodecount", &getmasternodecount, true, true, false},
        {"zdx", "masternodeconnect", &masternodeconnect, true, true, false},
        {"zdx", "masternodecurrent", &masternodecurrent, true, true, false},
        {"zdx", "masternodedebug", &masternodedebug, true, true, false},
        {"zdx", "startmasternode", &startmasternode, true, true, false},
        {"zdx", "createmasternodekey", &createmasternodekey, true, true, false},
        {"zdx", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"zdx", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"zdx", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"zdx", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"zdx", "getmasternodescores", &getmasternodescores, true, true, false},
        {"zdx", "mnbudget", &mnbudget, true, true, false},
        {"zdx", "preparebudget", &preparebudget, true, true, false},
        {"zdx", "submitbudget", &submitbudget, true, true, false},
        {"zdx", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"zdx", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"zdx", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"zdx", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"zdx", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"zdx", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"zdx", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"zdx", "checkbudgets", &checkbudgets, true, true, false},
        {"zdx", "mnsync", &mnsync, true, true, false},
        {"zdx", "spork", &spork, true, true, false},
        {"zdx", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"zdx", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use zdxd, or the -server option to zdx-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> zdx-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:19849/\n";
}
