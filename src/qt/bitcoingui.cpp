                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    GUIUtil::restoreWindowGeometry("nWindow", QSize(970, 740), this);

    QString windowTitle = tr("Zer-Dex ") ;
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Zer-Dex address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and ZDX: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zZDX"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Zer-Dex"), this);
    aboutAction->setStatusTip(tr("Show information about Zer-Dex"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Zer-Dex"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Zer-Dex addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Zer-Dex addresses"));
    ...
    openAction->setStatusTip(tr("Open a ZDX: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show help message to get a list with possible Zer-Dex command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Zer-Dex ") + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Zer-Dex network", "", count));
}
...
{
    QString strTitle = tr("Zer-Dex Wallet"); // default title
