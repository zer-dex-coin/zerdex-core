...
static Checkpoints::MapCheckpoints mapCheckpoints =
	...
	(303550, uint256("c2e8aaf041578434b9383ef733c79d7e130e985ac68ceb2cf188458e6cd3d75c"))
	(349390, uint256("d41caaf88f22ad0cf5b79bda85fb96ee0fa70aa3d144afd3336c0b7fe0300258"))
	;
...
public:
    CMainParams()
    {
        ...
        strSporkKey = "04f916d0315eb8c0bd47ed14f53aace1314ff3520a3c45ef9a6a49f5e6e58217587c0e05133d779dd6aff9847767696a4ef75ac2be6530676542ae3e20a4689d10";
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // Zdx: 1 day
        nTargetSpacing = 60;  // Zdx: 1 minute
        //nTargetSpacing = 20;  // Zdx: 20 seconds FAST TRACK TEST!!!
        nLastPOWBlock = 1500;
        nMaturity = 15;
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("seed1", "testnet.zdxplorer.info"));
...
public:
    CRegTestParams()
    {
        ...
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // Zdx: 1 day
        nTargetSpacing = 90;        // Zdx: 1.5 minutes
