...
In order to support loading of multiple wallets in zdx-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is zdx.cpp.
...
Changes to zdx.cpp
----------------------
zdx.cpp is the entry point into zdx-qt, and as such, will require some minor modifications to provide hooks for
